...
describe('tracespace core', () => {
  ...
  let plotter: typeof import('@tracespace/legacy-plotter')
  let renderer: typeof import('@tracespace/legacy-renderer')
  ...
  beforeEach(async () => {
    ...
    plotter = await replaceEsm('@tracespace/legacy-plotter')
    renderer = await replaceEsm('@tracespace/legacy-renderer')
